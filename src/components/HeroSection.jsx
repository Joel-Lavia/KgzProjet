...
return(
<section className="bg-heroImg lg:bg-cover lg:bg-center lg:h-screen  lg:bg-fixed rounded-xl lg:flex items-center lg:justify-around lg:gap-96 smartphone:bg-cover smartphone:bg-center smartphone:min-h-screen  smartphone:flex smartphone:justify-center">
